...
public partial class Exe201Context : DbContext
{
    ...
    public virtual DbSet<NumberOfPage> NumberOfPages { get; set; }
...
.AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
    ...
    {
        modelBuilder.Entity<NumberOfPage>(entity =>
        {
            entity.HasKey(e => e.NumberId);

            entity.ToTable("NumberOfPage");
        ...
        {
            entity.HasIndex(e => e.SizeId, "IX_Projects_Size_id");

            entity.HasIndex(e => e.PaperId, "IX_Projects_paper_id");

            entity.HasIndex(e => e.SpringId, "IX_Projects_spring_id");
            ...
            entity.HasOne(d => d.Number).WithMany(p => p.Projects)
